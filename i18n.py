...
LANGUAGES = {
    "kh": {
        ...
        "info_gen_agentic": "ត្រូវការម៉ូដែលធំ (Gemma-4-E4B+)",
        "info_gen_agentic_detail": "បើក៖ ម៉ូដែលអាចប្រើ web search អានទំព័របណ្តាញ និងបំលែងឯកសារ/URL សំឡេងទៅជាអក្សរដោយខ្លួនឯង មុននឹងឆ្លើយ (ត្រូវការម៉ូដែលមានសមត្ថភាពគ្រប់គ្រាន់ ចាប់ពី Gemma-4-E4B ឡើងទៅ)។ បិទ៖ ការសន្ទនាផ្ទាល់ធម្មតា គ្មានឧបករណ៍។",
        ...
        "info_rag_agentic": "ត្រូវការម៉ូដែលធំ (Gemma-4-E4B+)",
        "info_rag_agentic_detail": "បើក៖ ម៉ូដែលសម្រេចចិត្តដោយខ្លួនឯងថាតើ/ពេលណាត្រូវស្វែងរក ហើយអាចស្វែងរកច្រើនដង (ត្រូវការម៉ូដែលមានសមត្ថភាពគ្រប់គ្រាន់ ចាប់ពី Gemma-4-E4B ឡើងទៅ)។ បិទ៖ កម្មវិធីទាញយកបរិបទជានិច្ចជាមុនសិន រួចម៉ូដែលឆ្លើយផ្ទាល់ដោយគ្មានការហៅ tool — ជឿទុកចិត្តបានច្រើនជាងសម្រាប់ម៉ូដែលតូច ឬចាស់ (ឧ. Gemma-4-E2B)។",
        "tab_deep_research": "🔬 ស្រាវជ្រាវស៊ីជម្រៅ",
        "tab_deep_research_desc": "ភ្នាក់ងារ AI ពីរជាន់៖ Agent គ្រប់គ្រងបំបែកសំណួររបស់អ្នកជាសំណួររងៗ រៀបចំផែនការឡើងវិញឥតឈប់ឈរ ហើយប្រគល់សំណួររងនីមួយៗឱ្យ agent ស្វែងរកតាមអ៊ីនធឺណិតដាច់ដោយឡែក រួចសំយោគជារបាយការណ៍ Markdown ដែលមានប្រភពយោង។ ⚠️ ត្រូវការម៉ូដែលធំគ្រប់គ្រាន់ (ចាប់ពី Gemma-4-E4B ឡើងទៅ) និងចំណាយពេលយូរជាងការសន្ទនាទូទៅ។",
        ...
        "label_analysis_type": "📋 ប្រភេទការវិភាគ",
        "analysis_exploratory": "🔍 វិភាគរុករក",
        "analysis_sales": "💰 វិភាគការលក់",
        "analysis_customer": "👥 វិភាគអតិថិជន",
        "analysis_financial": "💹 វិភាគហិរញ្ញវត្ថុ",
        "analysis_payroll": "💰 គណនាប្រាក់ខែ",
        "tab_about": "ℹ️ អំពីកម្មវិធី",
        "tab_settings": "⚙️ ការកំណត់",
        "tab_settings_desc": "គ្រប់គ្រង និងកំណត់ម៉ូដែល ឧបករណ៍ និងការកំណត់ទាំងអស់នៅទីនេះ",
        "acc_settings_global": "🌐 ការកំណត់សកល និង Provider / Backend",
        "acc_settings_general": "💬 ការកំណត់ General Chat",
        "acc_settings_vision": "🖼️ ការកំណត់ Vision Chat",
        "acc_settings_stt": "🎙️ ការកំណត់ Speech to Text",
        "acc_settings_data": "📊 ការកំណត់ Data Analysis",
        "acc_settings_kb": "📂 ការកំណត់ Knowledge Base",
        "acc_settings_rag": "📚 ការកំណត់ RAG Chat",
        "acc_settings_dr": "🔍 ការកំណត់ Deep Research",
        "accordion_settings": "⚙️ ការកំណត់",
        "accordion_model_settings": "⚙️ ការកំណត់ម៉ូដែល",
        ...
        "btn_free_vram": "💥 ទំនេរ VRAM ទាំងអស់",
        ...
        "label_res": "លទ្ធផល",
        "doc_table_headers": ["ប្រភព", "ប្រភេទ", "ទំព័រ", "ចំនួន Chunk", "ប្រធានបទ", "រងប្រធានបទ"],
        "label_kb_docs": "📋 ឯកសារដែលបានបញ្ចូល",
        "header_docs": "--- \n### 📋 ឯកសារដែលបានបញ្ចូល",
        "accordion_add": "📤 បន្ថែមឯកសារ",
        "file_label": "ទម្លាក់ PDF / TXT / MD / DOCX",
        "theme_label": "📑 ប្រធានបទ",
        "subtheme_label": "📂 រងប្រធានបទ",
        "theme_placeholder": "ឧទាហរណ៍៖ ការអប់រំ",
        "subtheme_placeholder": "ឧទាហរណ៍៖ គណនេយ្យ",
        "lang_label": "ភាសា",
    ...
    "en": {
        ...
        "info_gen_agentic": "Needs a capable model (Gemma-4-E4B+)",
        "info_gen_agentic_detail": "ON: the model can use live web search, read full webpages, and transcribe audio files/URLs by itself before answering (needs a capable model — roughly Gemma-4-E4B or above). OFF: a plain direct conversation with no tools.",
        ...
        "info_rag_agentic": "Needs a capable model (Gemma-4-E4B+)",
        "info_rag_agentic_detail": "ON: the model decides for itself whether/when to search, and can search more than once (needs a capable model — roughly Gemma-4-E4B or above). OFF: the app always retrieves context first, then the model answers directly with no tool-calling — far more reliable for small or older models (e.g. Gemma-4-E2B).",
        "tab_deep_research": "🔬 Deep Research",
        "tab_deep_research_desc": "A two-agent setup: a manager agent breaks your question into sub-questions, periodically re-plans, and delegates each sub-question to a dedicated web-search agent, then synthesizes a structured Markdown report with sources. ⚠️ Needs a genuinely capable model (roughly Gemma-4-E4B or above) and takes noticeably longer than General Chat.",
        ...
        "label_analysis_type": "📋 Analysis Type",
        "analysis_exploratory": "🔍 Exploratory",
        "analysis_sales": "💰 Sales Analysis",
        "analysis_customer": "👥 Customer Analysis",
        "analysis_financial": "💹 Financial Analysis",
        "analysis_payroll": "💰 Payroll Calculation",
        "tab_about": "ℹ️ About",
        "tab_settings": "⚙️ Settings",
        "tab_settings_desc": "Manage and configure all model, tool, and system settings in one place.",
        "acc_settings_global": "🌐 Global & Provider / Backend Settings",
        "acc_settings_general": "💬 General Chat Settings",
        "acc_settings_vision": "🖼️ Vision Chat Settings",
        "acc_settings_stt": "🎙️ Speech to Text Settings",
        "acc_settings_data": "📊 Data Analysis Settings",
        "acc_settings_kb": "📂 Knowledge Base Settings",
        "acc_settings_rag": "📚 RAG Chat Settings",
        "acc_settings_dr": "🔍 Deep Research Settings",
        "accordion_settings": "⚙️ Settings",
        "accordion_model_settings": "⚙️ Model Settings",
        ...
        "label_res": "Result",
        "doc_table_headers": ["Source", "Type", "Pages", "Chunks", "Theme", "Subtheme"],
        "label_kb_docs": "📋 Indexed Documents",
        "header_docs": "--- \n### 📋 Indexed Documents",
        "accordion_add": "📤 Add Documents",
        "file_label": "Drop PDF / TXT / MD / DOCX",
        "theme_label": "📑 Theme",
        "subtheme_label": "📂 Subtheme",
        "theme_placeholder": "e.g. Education",
        "subtheme_placeholder": "e.g. Accounting",
        "lang_label": "Language",
